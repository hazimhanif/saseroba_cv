...
<head>
    ...
    <title>SASEROBA - <?php echo $mydata["DisplayName"]; ?> Curriculum Vitae</title>
...
<body>
        ...
        <div class="sidebar-wrapper">
            ...
            <div class="education-container container-block">
                ...
                <div class="item">
                    ...
                    <h5 class="meta"><?php echo $mydata["$var2"];?></h5>
    ...
    <footer class="footer">
        <div class="text-center">
                ...
                <small class="copyright">UI template provided by <a href="http://themes.3rdwavemedia.com" target="_blank">Xiaoying Riley</a></small>
        </div><!--//container-->
    </footer><!--//footer-->
