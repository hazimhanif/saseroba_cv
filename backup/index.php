...
<head>
  ...
  <title>SASEROBA - Curriculum Vitae</title>
...
<body id="page-top">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#howto">SEARCH</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
            ...
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">EXPLORE CVs</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <header class="masthead bg-primary text-secondary text-center">
      <div class="container">
        ...
        <h1 class="mb-0">SASEROBA Curriculum Vitae Repository</h1>
      </div>
    </header>
  ...
  <section id="contact">
    <div class="container">
      <h2 class="text-center text-uppercase text-secondary mb-0">Search</h2>
      <hr class="line mb-5">
      <div class="row">
